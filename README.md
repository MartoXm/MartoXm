<p align="center">
  <img src="Capa_Readme.png" alt="Capa do perfil de Gabriel Martorelli" />
</p>

<h1 align="center">👋 Olá! Eu sou o Gabriel Martorelli</h1>

<p align="center">
  Estudante de <strong>Sistemas de Informação</strong> e Desenvolvedor <strong>Fullstack em formação</strong>.<br />
  Construindo aplicações reais com <strong>.NET 10, C#, React e TypeScript</strong>.<br />
  🎯 Em busca da minha primeira oportunidade como <strong>Estagiário em Desenvolvimento Fullstack</strong>.
</p>
...
<p align="center">
  ...
  <a href="https://app.martodev.online/" target="_blank">
...
Sou estudante de Sistemas de Informação, com interesse em desenvolvimento Fullstack e arquitetura de software.

Busco construir aplicações organizadas, funcionais e fáceis de manter, aplicando boas práticas como **DDD**, **SOLID**, separação de responsabilidades e documentação de APIs. Atualmente, aprofundo meus conhecimentos em **C#/.NET** no backend e **React com TypeScript** no frontend.

> 🌱 Atualmente estudando: **Clean Architecture, Entity Framework Core, testes unitários com xUnit e Tailwind CSS.**
...
**Arquitetura e qualidade:** DDD · SOLID · Clean Architecture · Clean Code · APIs REST · Testes unitários com xUnit

**Bibliotecas e ferramentas:** Entity Framework Core · Swagger/OpenAPI · FluentValidation · AutoMapper · Axios
